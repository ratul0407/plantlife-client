    ...
    <div className="mx-auto max-w-6xl space-y-16 p-6">
      ...
      <section className="space-y-8 text-lg leading-relaxed">
        ...
        <p>
          ...
          placerat orci, non faucibus enim leo ac risus. Integer quis sapien nec
          ligula mattis facilisis. Curabitur semper mi vel sapien imperdiet, ac
          feugiat ligula vehicula.
        </p>
